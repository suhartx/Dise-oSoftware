...
public class CrearEntrenamientoWindow {
	...
	private void initialize() {
		...
		kmSpinner.setBounds(112, 0, 30, 20);
		...
		hourSpinner.setBounds(72, 0, 30, 20);
		...
		minutesSpinner.setBounds(168, 0, 30, 20);
		...
		secondsSpinner.setBounds(276, 1, 30, 20);
		...
		backButton.setBounds(0, 8, 118, 23);
