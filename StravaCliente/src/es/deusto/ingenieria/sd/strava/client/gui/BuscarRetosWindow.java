...
public class BuscarRetosWindow {
	...
	private void initialize() {
		...
		nombreTextPanel_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		fechasPanel_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		distanciaPanel_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		tiempoPanel_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
